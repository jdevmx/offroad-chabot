...
If any aspect of the product idea, target market, or strategic context is ambiguous or missing, STOP and ask the user targeted clarifying questions before proceeding. Never assume or infer silently — list each ambiguity explicitly and wait for answers.
